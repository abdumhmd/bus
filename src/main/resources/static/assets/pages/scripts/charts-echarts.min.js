jQuery(document).ready(function () {
    require.config({
        ...
        var r = e.init(document.getElementById("echarts_scatter"));
        r.setOption({
            tooltip: {
                trigger: "item"
            },
            ...
            series: [{
                ...
                symbolSize: 5,
                data: function () {
                    for (var e, a = [], t = 500; t--;) e = (100 * Math.random()).toFixed(2) - 0, a.push([(Math.random() * e + e).toFixed(2) - 0, (Math.random() * e).toFixed(2) - 0, e]);
                    return a
                }()
            }]
        });
        var o = e.init(document.getElementById("echarts_candle"));
        o.setOption({
            tooltip: {
                trigger: "axis",
                formatter: function (e) {
                    var a = e[0].seriesName + " " + e[0].name;
                    return a += "<br/>  Opening : " + e[0].value[0] + "  Highest : " + e[0].value[3], a += "<br/>  Closing : " + e[0].value[1] + "  Lowest : " + e[0].value[2]
                }
            },
            legend: {
            ...
            series: [{
                ...
                data: [{
                    ...
                    itemStyle: {
                        normal: {
                            color: function () {
                                var e = require("zrender/tool/color");
                                return e.getRadialGradient(300, 200, 110, 300, 200, 140, [[0, "rgba(255,255,0,1)"], [1, "rgba(30,144,250,1)"]])
                            }(),
                            label: {
                                textStyle: {
                ...
                itemStyle: {
                    ...
                    emphasis: {
                        color: function () {
                            var e = require("zrender/tool/color");
                            return e.getRadialGradient(650, 200, 80, 650, 200, 120, [[0, "rgba(255,255,0,1)"], [1, "rgba(255,0,0,1)"]])
                        }(),
                        label: {
                            show: !0,
                            position: "center",
