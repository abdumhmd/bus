    ...
    var table = $('#datatable_ajax').DataTable({
        ...
        "aoColumns": [
            ...
            { "mRender": function (data, type, row) {
                    return '<a role="button" href="/home/stationery/stock/view/'+row.id+'"><i class="fa fa-eye"></i></a>' +
                        '<a data-toggle="modal" data-target="#myModal'+row.id+'"><i class="fa fa-remove"></i></a>' +
